...
# load data set
X = np.load('/Users/artemiikhristich/PycharmProjects/sign2text/data/X.npy')
Y = np.load('/Users/artemiikhristich/PycharmProjects/sign2text/data/Y.npy')
...
print(base_model.evaluate(x = X_test, y = y_test)[1])
